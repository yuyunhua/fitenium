 ...
 */
public class Value implements IExecute {
    ...
    public StepResult execute(WebDriver driver, WebElement lastElement, TestStep step) {
        ...
        try {
            ...
            value = lastElement.getAttribute("value");
            value = null != value ? value : lastElement.getText();
        } catch (Exception e) {
        ...
        return new StepResult(step, code, lastElement, value, exception, null);
    }
